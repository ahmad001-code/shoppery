...
function ProductDetails() {
    ...
    return (
        <MainLayout>
            ...
            <AnimatedSection>
                <div className="mx-20 flex grid-cols-2 grid-rows-1 flex-col items-center justify-center lg:grid">
                    ...
                    <div className="flex flex-col pt-[50px] lg:pt-6 xl:px-20">
                        ...
                        <div className="flex items-center justify-center gap-3 border-b-[1px] pb-5 pt-5">
                            <Counter />
                            <button className="flex h-[50px] w-[300px] items-center justify-center gap-3 rounded-3xl bg-[#00B207] text-white lg:w-[450px]">
                                Add to Cart
                                <img
                                    className="h-4"
                                    w-4
